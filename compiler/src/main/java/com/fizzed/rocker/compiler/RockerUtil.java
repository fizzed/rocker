...
public class RockerUtil {
     ...
     */
	private static final String LINE_START = "\\v+\\h+";
	...
	static public List<String> getTextAsJavaByteArrayInitializer(String text, String charsetName, int maxArraySize)
